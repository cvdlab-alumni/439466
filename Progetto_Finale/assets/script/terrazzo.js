function creaTerrazzo(x,y,z,texture){
	var terrazzo = createMesh(new THREE.BoxGeometry(x, y,z), texture);
	return terrazzo;
}
		...
		object.scale.set(0.02,0.02,0.02);
		      ...
		      loader5.addEventListener('load', function (event) {
		       ...
		       // object.rotation.y =Math.PI;
		        ...
		        object.position.set(30,-2.2,0.6);
		...
		object.scale.set(0.15,0.15,0.15);
		      ...
		      loader4.addEventListener('load', function (event) {
		       ...
		       // object.rotation.y =Math.PI;
		        ...
		        object.position.set(20,-2.2,0.6);
		...
		object.scale.set(0.15,0.15,0.15);
		      ...
		      loader6.addEventListener('load', function (event) {
		       ...
		       // object.rotation.y =Math.PI;
		        ...
		        object.position.set(40,-2.2,0.6);
		...
		object.scale.set(0.15,0.15,0.15);
		      ...
		      loader7.addEventListener('load', function (event) {
		       ...
		       // object.rotation.y =Math.PI;
		        ...
		        object.position.set(50,-2.2,0.6);
