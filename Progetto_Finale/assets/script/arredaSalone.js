...
object.scale.set(0.03,0.03,0.03);
      ...
      loader2.addEventListener('load', function (event) {
        ...
        object.rotation.x =Math.PI/2;
        object.rotation.y =-Math.PI/2;
        object.position.set(59,1.8,1.6);
object.scale.set(0.1,0.1,0.1);
      ...
      loader3.addEventListener('load', function (event) {
        ...
        object.rotation.x =Math.PI/2;
        object.rotation.y =-Math.PI/2;
        object.position.set(23,1.8,1.6);
object.scale.set(0.1,0.1,0.1);
       // mesh = object;
        mesh.add(object);
      ...
      loader4.addEventListener('load', function (event) {
        ...
        object.rotation.x =Math.PI/2;
        object.rotation.y =-Math.PI/2;
        object.position.set(37,12.2,1.6);
object.scale.set(0.1,0.1,0.1);
       // mesh = object;
        mesh.add(object);
      ...
      loader5.addEventListener('load', function (event) {
        ...
        object.position.set(40,1.2,0.6);
...
object.scale.set(0.35,0.35,0.35);
      ...
      loader9.addEventListener('load', function (event) {
        ...
        object.rotation.x =Math.PI/2;
       object.rotation.y =Math.PI/2;
        object.position.set(28,4.2,0.8);
object.scale.set(0.03,0.03,0.03);
       // mesh = object;
        mesh.add(object);
